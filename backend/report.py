...
def render_analysis_report(analysis: dict[str, Any]) -> str:
    ...
    for index, chart in enumerate(charts, start=1):
        ...
        # Embed chart HTML in a sandboxed-looking card (full HTML already includes plotly.js)
    ...
    if sample and columns:
        ...
        sample_rows = f"<table><thead><tr>{head}</tr></thead><tbody>{''.join(body_rows)}</tbody></table>"
    ...
    narrative = html.escape(str(summary.get("narrative") or summary.get("headline") or ""))
...
<body>
  <div class="wrap">
    ...
    <div class="footer">
      Generated by Prysm — AI data analysis, refracted into insight.
    </div>
  </div>
</body>
</html>
